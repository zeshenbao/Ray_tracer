...
rum = [Sphere(0.7, Vector(0.75, -0.3, 1.5), Material(RGB(0,100,0))),
       Sphere(0.4, Vector(-0.75, -0.1, 2.25), Material()),
       Sphere(10000, Vector(0, 10000.5, 1), Chessboard(RGB(255, 255, 255), RGB(0, 0, 0), 0, 1.0, 1.0, 0.2))]

lights = [Light(Point(1.5, -0.5, -1))] #Light(Point(-0.5, -5.5, 0.0))]


bild = render(width, height, rum, kamera, lights)


with open("bild88.ppm", "w") as bild_fil:
    ppm(bild_fil, bild)
